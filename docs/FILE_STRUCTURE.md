...
| File | Purpose |
| --- | --- |
| [STRATEGY.md](STRATEGY.md) | Battery control strategy flowchart |
| [USAGE.md](USAGE.md) | CLI usage, cron setup, token management |
...
| [REPO_STYLE.md](REPO_STYLE.md) | Repository layout conventions |
| [MARKDOWN_STYLE.md](MARKDOWN_STYLE.md) | Markdown formatting rules |
| [EPCUBE_API_FIELDS.md](EPCUBE_API_FIELDS.md) | EP Cube API field reference |
| [EPCUBE_MODE_BEHAVIOR.md](EPCUBE_MODE_BEHAVIOR.md) | EP Cube mode behavior and capabilities |
| [CLAUDE_HOOK_USAGE_GUIDE.md](CLAUDE_HOOK_USAGE_GUIDE.md) | Claude Code permissions hook guide |
| [FILE_STRUCTURE.md](FILE_STRUCTURE.md) | Directory layout and file purposes |
...
- **Documentation**: add `SCREAMING_SNAKE_CASE.md` files to [docs/](./).
